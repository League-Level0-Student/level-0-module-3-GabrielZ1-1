...
public class ShinyObjects {
	...
	void manyShinyObjects() {
		...
		String numberOfShinyObjectsAsString = JOptionPane.showInputDialog("How many shiny objects do you want?");

		int numberOfShinyObjectsAsInt = Integer.parseInt(numberOfShinyObjectsAsString);
		// 3. Play the sound that many times

		for(int i = 0; i < numberOfShinyObjectsAsInt; i++) {
playMisterZee();
